	...
	public function register_menu_page() {
		...
		if ( isset( $admin_page_hooks['jet-dashboard'] ) ) {
			...
			add_menu_page(
				...
				$this->page_slug,
				array( $this, 'render_wizard' ),
				'data:image/svg+xml;base64,' . base64_encode( '<svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M16.0767 0.00309188C17.6897 -0.0870077 18.6099 1.81257 17.5381 3.02007L7.99824 13.7682C6.88106 15.0269 4.79904 14.2223 4.82092 12.5403L4.87766 8.17935C4.88509 7.60797 4.62277 7.06644 4.16961 6.71768L0.710961 4.05578C-0.623014 3.02911 0.0373862 0.899003 1.71878 0.805085L16.0767 0.00309188Z" fill="white"/></svg>' ),
				59
			);
		}
